...
class BaseQuery {
  ...
  /**
   * Adds the given search string to be applied over all
   * searchable fields. The resulting query will return
   * results where any searchable field matches the specified
   * search string.
   *
   * @param {string} searchStr - the search string
   * @returns {BaseQuery} the updated query instance
