...
class API {
   ...
   * @return {Object} an object mapping analytic IDs to objects indicating
   *   whether the analytic was successfully processed. The `success` field
   *   will be set to `true` on success or `false` on failure
   * @throws {APIError} if the request was unsuccessful
   */
   ...
   * @return {Object} an object mapping data IDs to objects indicating
   *   whether the data was successfully processed. The `success` field
   *   will be set to `true` on success or `false` on failure
   * @throws {APIError} if the request was unsuccessful
   */
   ...
   * @return {Object} an object mapping job IDs to objects indicating
   *   whether the job was successfully processed. The `success` field
   *   will be set to `true` on success or `false` on failure
   * @throws {APIError} if the request was unsuccessful
   */
