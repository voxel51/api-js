...
class API {
   ...
   *   `false` on failure, and the `result` field will contain the analytic
   ...
   *   `success` field of each response will be set to `true` on success or
   *   `false` on failure, and the `result` field will contain the data details
   *   in the same format as returned by `getDataDetails()`
   * @throws {APIError} if the request was unsuccessful
   */
   ...
   *   `success` field of each response will be set to `true` on success or
   *   `false` on failure, and the `result` field will contain the job details
