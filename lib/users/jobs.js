...
class JobRequest extends utils.Serializable {
   ...
   *
   * @param {string} name - the parameter name to set
   * @param {*} val - the parameter value, which must be JSON serializable
   */
...
class RemoteDataPath extends utils.Serializable {
  ...
  /**
   * Checks whether this RemoteDataPath has a data ID.
   *
   * @return {boolean}
   */
  get hasDataId() {
  ...
  /**
   * Checks whether this RemoteDataPath is valid.
   *
   * @return {boolean}
   */
  get isValid() {
   ...
   * dictionary.
   *
   * @param {object} val - either an object representation of a RemoteDataPath
