...
class RemoteDataPath extends utils.Serializable {
   ...
   * @memberof RemoteDataPath
   * @property hasDataId
   * @return {boolean} true if this instance has a data ID, and false otherwise
   */
  get hasDataId() {
   ...
   *
   * @memberof RemoteDataPath
   * @property hasSignedUrl
   * @return {boolean} true if this instance has a signed URL, and false
   *   otherwise
   */
  get hasSignedUrl() {
   ...
   * @memberof RemoteDataPath
   * @property isValid
   * @return {boolean} true if this instance is valid, and false otherwise
   */
  get isValid() {
