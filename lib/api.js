...
const BASE_URL = 'https://api.voxel51.com/v1';  // production
//const BASE_URL = 'https://staging.api.voxel51.com/v1';  // staging
//const BASE_URL = 'https://dev.api.voxel51.com/v1';  // development
...
class API {
   ...
   * @throws {APIError} if the request was unsuccessful
   */
  async postDataAsURL(url, filename, mimeType, size, encoding) {
