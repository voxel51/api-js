...
class API {
   ...
   *   the customzied analytics query to perform
   ...
   *
   * @async
   * @param {DataQuery} dataQuery A DataQuery instance defining the customzied
   ...
   *
   * @async
   * @param {JobsQuery} jobsQuery An JobsQuery instance defining the customzied
