...
class API {
  ...
  /**
   * Extends the expiration date of the data by the specified number of days.
   *
   ...
   * @throws {APIError} if the request was unsuccessful
   */
  async extendDataTTL(dataId, days) {
    let uri = this.baseURL + '/data/' + dataId + '/extend';
    let formData = {'days': autoStart.toString()};
