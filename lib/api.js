...
class API {
  ...
  async queryAnalytics({
    ...
    // TODO write general query uri constructor
    // let queryUri = generateQueryUri(queryObj);
    let uri = this.baseURL + '/analytics' + queryUri;
    let body = await requests.get(uri, this.header_);
    return JSON.parse(body).analytics;
  }
  ...
  async queryData({
    ...
    // TODO create generalized function for creating query string
    // let queryUri = generateQueryUri(queryObj);
    let uri = this.baseURL = '/data' + queryUri;
    let body = await requests.get(uri, this.header_);
    return JSON.parse(body).data;
  }
  ...
  async queryJobs(queryObj = {
    ...
    // TODO write general query uri constructor
    // let queryUri = generateQueryUri(queryObj);
    let uri = this.baseURL + '/jobs' + queryUri;
    let body = await requests.get(uri, this.header_);
    return JSON.parse(body).jobs;
  }
  ...
  // TODO determine purpose of this route
  // TYPES FUNCTIONS
  ...
  */
  ...
  // TODO what do we want to provide here?
  // STATEMENT FUNCTIONS
}
